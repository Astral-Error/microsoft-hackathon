...
// Initialize DB
if (!localStorage.getItem('lib_db_v3')) {
    localStorage.setItem('lib_db_v3', JSON.stringify(initialData));
}

const db = JSON.parse(localStorage.getItem('lib_db_v3'));

function saveDb() {
    localStorage.setItem('lib_db_v3', JSON.stringify(db));
}
